...
const dictionary = {
    th: { 
        ...
        menu:[
            {name:"สปาเก็ตตี้คาโบนาร่า", price:79, img:"1.jpg"},
            {name:"สปาเก็ตตี้ซอสขี้เมาหมู", price:69, img:"2.jpg"},
            {name:"สปาเก็ตตี้ซอสมะเขือเทศหมูสับ", price:69, img:"3.jpg"},
            {name:"สปาเก็ตตี้ซอสมะเขือเทศไก่สับ", price:69, img:"3.jpg"},
            {name:"ผักโขมอบชีส", price:59, img:"4.jpg"},
            {name:"หมูแดดเดียว", price:50, img:"5.jpg"},
            {name:"ซุปเห็ด", price:49, img:"6.jpg"},
            {name:"ซุปผักโขม", price:49, img:"7.jpg"},
            {name:"นักเก็ต", price:45, img:"8.jpg"},
            {name:"เฟรนช์ฟรายส์", price:39, img:"9.jpg"},
            {name:"ไก่ป๊อป", price:45, img:"10.jpg"},
            {name:"ไก่ป๊อปสไปซี่", price:45, img:"10.jpg"},
            {name:"ฟิชแอนด์ชิปส์", price:69, img:"11.jpg"},
            {name:"ข้าวหน้าสเต็กไก่ย่าง", price:59, img:"13.jpg"},
            {name:"ข้าวหน้าสเต็กหมูย่าง", price:99, img:"14.jpg"},
            {name:"ข้าวหน้าสเต็กไก่ทอดกรอบ", price:59, img:"15.jpg"},
            {name:"ข้าวหน้าสเต็กสันคอหมู", price:169, img:"16.jpg"},
            {name:"ข้าวหน้าสเต็กโคขุน", price:119, img:"17.jpg"},
            {name:"ข้าวหน้าสเต็กแซลมอน", price:189, img:"18.jpg"},
            {name:"ข้าวหน้าปลาสเต็กทอดกรอบ", price:59, img:"19.jpg"},
            {name:"ข้าวหน้าปลาซาบะญี่ปุ่นย่าง", price:89, img:"20.jpg"},
            {name:"ข้าวหน้าสเต็กหมูบด", price:79, img:"21.jpg"},
            {name:"ข้าวหน้าสเต็กเนื้อบด", price:99, img:"22.jpg"},
            {name:"ข้าวหมูคั่วกลิ้ง", price:49, img:"23.jpg"},
            {name:"สลัดสเต็กปลาทอด", price:69, img:"24.jpg"},
            {name:"สลัดสเต็กอกไก่ย่าง", price:69, img:"25.jpg"},
            {name:"สลัดสเต็กหมูย่าง", price:99, img:"26.jpg"},
            {name:"สลัดผัก", price:49, img:"27.jpg"},
            {name:"สเต็กเนื้อโคคุน", price:109, img:"28.jpg"},
            {name:"ริปอายสเต็กเนื้อ", price:119, img:"29.jpg"},
            {name:"ที-โบน สเต็กเนื้อ", price:199, img:"30.jpg"},
            {name:"สเต็กปลาซาบะ", price:79, img:"31.jpg"},
            {name:"สเต็กปลาทอด", price:109, img:"32.jpg"},
            {name:"สเต็กปลาย่างน้ำจิ้มซีฟู้ด", price:99, img:"33.jpg"},
            {name:"สเต็กปลาแซลมอน", price:179, img:"34.jpg"},
            {name:"พอร์คชอพ", price:109, img:"35.jpg"},
            {name:"พอร์คชอพซอสสไปซี่", price:109, img:"36.jpg"},
            {name:"พอร์คชอพซอสบาร์บีคิว", price:109, img:"36.jpg"},
            {name:"ซี่โคครงบาร์บีคิว", price:169, img:"37.jpg"},
            {name:"สเต็กหมูบด", price:69, img:"38.jpg"},
            {name:"สเต็กเนื้อบด", price:89, img:"39.jpg"},
            {name:"เบอร์เกอร์หมู", price:69, img:"40.jpg"},
            {name:"เบอร์เกอร์เนื้อ", price:89, img:"41.jpg"},
            {name:"สเต็กไก่", price:49, img:"42.jpg"},
            {name:"สะโพกไก่สไปซี่", price:89, img:"43.jpg"},
            {name:"สเต็กไก่ซอสบาร์บีคิว", price:59, img:"44.jpg"},
            {name:"สเต็กไก่ซอสสไปซี่", price:59, img:"44.jpg"},
            {name:"สเต็กหมู", price:89, img:"45.jpg"},
            {name:"สเต็กหมูซอสบาร์บีคิว", price:89, img:"46.jpg"},
            {name:"สเต็กหมูซอสสไปซี่", price:89, img:"46.jpg"},
            {name:"สเต็กหมูสไปซี่", price:109, img:"47.jpg"},
            {name:"สเต็กสันคอหมู", price:169, img:"48.jpg"},
            {name:"สเต็กสันคอหมูซอสบาร์บีคิว", price:169, img:"49.jpg"},
            {name:"สเต็กสันคอหมูซอสสไปซี่", price:169, img:"49.jpg"},
            {name:"ไก่ + ปลา + หมู", price:219, img:"50.jpg"},
            {name:"ไก่ + ปลา + โคขุน", price:229, img:"51.jpg"},
            {name:"ไก่ + โคขุน + พอร์คชอพ + ปลา", price:299, img:"52.jpg"},
            {name:"สันคอ + ปลา", price:249, img:"53.jpg"},
            {name:"พอร์คชอพ + โคขุน", price:189, img:"54.jpg"},
            {name:"พอร์คชอพ + ทีโบน", price:289, img:"55.jpg"},
            {name:"หมู + พอร์คชอพ + สันคอ", price:339, img:"56.jpg"},
            {name:"แซลมอน + ทีโบน", price:339, img:"57.jpg"},
            {name:"พอร์คชอพ + ทีโบน + แซลมอน", price:419, img:"58.jpg"},
            {name:"โคขุน + ริบอาย + ทีโบน", price:389, img:"59.jpg"},
            {name:"ไก่ + หมู + โคขุน + ปลา + แซลม่อน", price:459, img:"60.jpg"},
            {name:"แซลมอน + พอร์คชอพ + ริบอาย", price:349, img:"61.jpg"},
            {name:"ปลา + ไก่ + พอร์คชอพ + สันคอ + ริบอาย + ทีโบน", price:599, img:"62.jpg"}
        ]
    },
    en: { 
        ...
        menu:[
            {name:"Spaghetti Carbonara", price:79, img:"1.jpg"},
            {name:"Spaghetti with Spicy Thai Basil Sauce Pork", price:69, img:"2.jpg"},
            {name:"Spaghetti with Tomato Sauce and Minced Pork", price:69, img:"3.jpg"},
            {name:"Spaghetti with Tomato Sauce and Minced Chicken", price:69, img:"3.jpg"},
            {name:"Baked Spinach with Cheese", price:59, img:"4.jpg"},
            {name:"Thai-Style Sun-Dried Pork", price:50, img:"5.jpg"},
            {name:"Creamy Mushroom Soup", price:49, img:"6.jpg"},
            {name:"Creamy Spinach Soup", price:49, img:"7.jpg"},
            {name:"Chicken Nuggets", price:45, img:"8.jpg"},
            {name:"French Fries", price:39, img:"9.jpg"},
            {name:"Popcorn Chicken", price:45, img:"10.jpg"},
            {name:"Spicy Popcorn Chicken", price:45, img:"10.jpg"},
            {name:"Fish & Chips", price:69, img:"11.jpg"},
            {name:"Grilled Chicken Steak Rice Bowl", price:59, img:"13.jpg"},
            {name:"Rice with Grilled Pork Steak", price:99, img:"14.jpg"},
            {name:"Rice with Crispy Fried Chicken Steak", price:59, img:"15.jpg"},
            {name:"Rice with Grilled Pork Neck Steak", price:169, img:"16.jpg"},
            {name:"Thai Premium Beef Steak Rice", price:119, img:"17.jpg"},
            {name:"Rice with Grilled Salmon Steak", price:189, img:"18.jpg"},
            {name:"Rice with Crispy Fried Fish Steak", price:59, img:"19.jpg"},
            {name:"Japanese Grilled Saba Rice", price:89, img:"20.jpg"},
            {name:"Rice with Pork Patty Steak", price:79, img:"21.jpg"},
            {name:"Rice with Beef Hamburger Steak", price:99, img:"22.jpg"},
            {name:"Southern Thai Spicy Pork Stir-Fry on Rice", price:49, img:"23.jpg"},
            {name:"Salad with Crispy Fried Fish Steak", price:69, img:"24.jpg"},
            {name:"Salad with Grilled Chicken Breast Steak", price:69, img:"25.jpg"},
            {name:"Salad with Grilled Pork Steak", price:99, img:"26.jpg"},
            {name:"Fresh Garden Salad", price:49, img:"27.jpg"},
            {name:"Thai Premium Beef Steak", price:109, img:"28.jpg"},
            {name:"Grilled Ribeye Beef Steak", price:119, img:"29.jpg"},
            {name:"T-Bone Beef Steak", price:199, img:"30.jpg"},
            {name:"Japanese Saba Steak", price:79, img:"31.jpg"},
            {name:"Crispy Fried Fish Steak", price:109, img:"32.jpg"},
            {name:"Grilled Fish Steak & Thai Spicy Dipping Sauce", price:99, img:"33.jpg"},
            {name:"Salmon Steak", price:179, img:"34.jpg"},
            {name:"pork chop", price:109, img:"35.jpg"},
            {name:"Spicy Pork Chop", price:109, img:"36.jpg"},
            {name:"BBQ Pork Chop", price:109, img:"36.jpg"},
            {name:"BBQ Ribs", price:169, img:"37.jpg"},
            {name:"Minced Pork Steak", price:69, img:"38.jpg"},
            {name:"Minced Beef Steak", price:89, img:"39.jpg"},
            {name:"Pork Burger", price:69, img:"40.jpg"},
            {name:"Beef Burger", price:89, img:"41.jpg"},
            {name:"Chicken Steak", price:49, img:"42.jpg"},
            {name:"Spicy Chicken Thigh", price:89, img:"43.jpg"},
            {name:"BBQ Chicken Steak", price:59, img:"44.jpg"},
            {name:"Spicy Chicken Steak", price:59, img:"44.jpg"},
            {name:"Pork Steak", price:89, img:"45.jpg"},
            {name:"Pork Steak BBQ Sauce", price:89, img:"46.jpg"},
            {name:"Pork Steak Spicy Sauce", price:89, img:"46.jpg"},
            {name:"Spicy Pork Steak", price:109, img:"47.jpg"},
            {name:"Pork Blade Steak", price:169, img:"48.jpg"},
            {name:"Pork Blade Steak BQQ Sauce", price:169, img:"49.jpg"},
            {name:"Pork Blade Steak Spicy Sauce", price:169, img:"49.jpg"},
            {name:"Chicken+Fish+Pork", price:219, img:"50.jpg"},
            {name:"Chicken+Fish+Premium Beef", price:229, img:"51.jpg"},
            {name:"Chicken + Premium Beef + Pork Chop + Fish", price:299, img:"52.jpg"},
            {name:"Pork Blade + Fish", price:249, img:"53.jpg"},
            {name:"Pork Chop + Premium Beef", price:189, img:"54.jpg"},
            {name:"Pork Chop + T-Bone Steak", price:289, img:"55.jpg"},
            {name:"Pork + Pork Chop + Pork Blade", price:339, img:"56.jpg"},
            {name:"Salmon + T-Bone Steak", price:339, img:"57.jpg"},
            {name:"Pork Chop + T-Bone Steak + Salmon", price:419, img:"58.jpg"},
            {name:"Premium Beef + Ribeye + T-Bone Steak", price:389, img:"59.jpg"},
            {name:"Chicken + Pork + Premium Beef + Fish + Salmon", price:459, img:"60.jpg"},
            {name:"Salmon + Pork Chop + Ribeye Steak", price:349, img:"61.jpg"},
            {name:"Fish + Chicken + Pork Chop + Pork Blade + Ribeye + T-Bone Steak", price:599, img:"62.jpg"}
        ]
    },
    zh: { 
        ...
        checkoutBtn:"去结账", 
        menu:[
            {name:"卡邦尼意大利面", price:79, img:"1.jpg"},
            {name:"泰式罗勒辣酱猪肉意大利面", price:69, img:"2.jpg"},
            {name:"番茄酱猪肉末意大利面", price:69, img:"3.jpg"},
            {name:"番茄酱鸡肉末意大利面", price:69, img:"3.jpg"},
            {name:"芝士焗菠菜", price:59, img:"4.jpg"},
            {name:"泰式风干猪肉", price:50, img:"5.jpg"},
            {name:"奶油蘑菇汤", price:49, img:"6.jpg"},
            {name:"奶油菠菜汤", price:49, img:"7.jpg"},
            {name:"炸鸡块", price:45, img:"8.jpg"},
            {name:"炸薯条", price:39, img:"9.jpg"},
            {name:"爆米花鸡", price:45, img:"10.jpg"},
            {name:"香辣爆米花鸡", price:45, img:"10.jpg"},
            {name:"炸鱼薯条", price:69, img:"11.jpg"},
            {name:"烤鸡排盖饭", price:59, img:"13.jpg"},
            {name:"烤猪排盖饭", price:99, img:"14.jpg"},
            {name:"炸鸡排盖饭", price:59, img:"15.jpg"},
            {name:"猪颈肉盖饭", price:169, img:"16.jpg"},
            {name:"优质牛排盖饭", price:119, img:"17.jpg"},
            {name:"三文鱼排盖饭", price:189, img:"18.jpg"},
            {name:"炸鱼排盖饭", price:59, img:"19.jpg"},
            {name:"日式烤鲭鱼盖饭", price:89, img:"20.jpg"},
            {name:"猪肉饼盖饭", price:79, img:"21.jpg"},
            {name:"牛肉饼盖饭", price:99, img:"22.jpg"},
            {name:"泰南香辣猪肉炒饭", price:49, img:"23.jpg"},
            {name:"炸鱼排沙拉", price:69, img:"24.jpg"},
            {name:"烤鸡胸肉排沙拉", price:69, img:"25.jpg"},
            {name:"烤猪排沙拉", price:99, img:"26.jpg"},
            {name:"蔬菜沙拉", price:49, img:"27.jpg"},
            {name:"优质牛排", price:109, img:"28.jpg"},
            {name:"肉眼牛排", price:119, img:"29.jpg"},
            {name:"T骨牛排", price:199, img:"30.jpg"},
            {name:"鲭鱼排", price:79, img:"31.jpg"},
            {name:"香脆炸鱼排", price:109, img:"32.jpg"},
            {name:"烤鱼排配泰式海鲜蘸酱", price:99, img:"33.jpg"},
            {name:"三文鱼排", price:179, img:"34.jpg"},
            {name:"猪排", price:109, img:"35.jpg"},
            {name:"香辣猪排", price:109, img:"36.jpg"},
            {name:"烧烤猪排", price:109, img:"36.jpg"},
            {name:"烧烤排骨", price:169, img:"37.jpg"},
            {name:"猪肉汉堡排", price:69, img:"38.jpg"},
            {name:"牛肉汉堡排", price:89, img:"39.jpg"},
            {name:"猪肉汉堡", price:69, img:"40.jpg"},
            {name:"牛肉汉堡", price:89, img:"41.jpg"},
            {name:"鸡排", price:49, img:"42.jpg"},
            {name:"香辣鸡腿", price:89, img:"43.jpg"},
            {name:"烧烤酱鸡排", price:59, img:"44.jpg"},
            {name:"香辣鸡排", price:59, img:"44.jpg"},
            {name:"猪排", price:89, img:"45.jpg"},
            {name:"烧烤酱猪排", price:89, img:"46.jpg"},
            {name:"香辣猪排", price:89, img:"46.jpg"},
            {name:"香辣酱猪排", price:109, img:"47.jpg"},
            {name:"猪颈肉排", price:169, img:"48.jpg"},
            {name:"烧烤酱猪颈肉排", price:169, img:"49.jpg"},
            {name:"香辣猪颈肉排", price:169, img:"49.jpg"},
            {name:"鸡 + 鱼 + 猪肉", price:219, img:"50.jpg"},
            {name:"鸡 + 鱼 + 优质牛肉", price:229, img:"51.jpg"},
            {name:"鸡 + 优质牛肉 + 猪排 + 鱼", price:299, img:"52.jpg"},
            {name:"猪颈肉 + 鱼", price:249, img:"53.jpg"},
            {name:"猪排 + 优质牛肉", price:189, img:"54.jpg"},
            {name:"猪排 + T骨牛排", price:289, img:"55.jpg"},
            {name:"猪肉 + 猪排 + 猪颈肉", price:339, img:"56.jpg"},
            {name:"三文鱼 + T骨牛排", price:339, img:"57.jpg"},
            {name:"猪排 + T骨牛排 + 三文鱼", price:419, img:"58.jpg"},
            {name:"优质牛肉 + 肋眼牛排 + T骨牛排", price:389, img:"59.jpg"},
            {name:"鸡 + 猪肉 + 优质牛肉 + 鱼 + 三文鱼", price:459, img:"60.jpg"},
            {name:"三文鱼 + 猪排 + 肋眼牛排", price:349, img:"61.jpg"},
            {name:"鱼 + 鸡肉 + 猪排 + 猪颈肉 + 肋眼牛排 + T骨牛排", price:599, img:"62.jpg"}
        ]
    }
};
